...
void Board::printBoard() {
	...
	for (int i = 0; i < 8; i++)
	{
		...
		for (int j = 0; j < 8; j++)
		{
			...
			switch (p)
			{
			case KING: (c == WHITE) ? cout << " K " : cout << "\033[32m k \033[0m";
				break;
			case QUEEN: (c == WHITE) ? cout << " Q " : cout << "\033[32m q \033[0m";
				break;
			case BISHOP:(c == WHITE) ? cout << " B " : cout << "\033[32m b \033[0m";
				break;
			case KNIGHT:(c == WHITE) ? cout << " H " : cout << "\033[32m h \033[0m";
				break;
			case ROOK: (c == WHITE) ? cout << " R " : cout << "\033[32m r \033[0m";
				break;
			case PAWN: (c == WHITE) ? cout << " P " : cout << "\033[32m p \033[0m";
				break;
			case EMPTY: cout << " " << "\21" << " ";
				break;
			default: cout << "XXX";
...
bool Board::doMove() {
	...
	while (!stop)
	{
		...
		cout << "For example piece (0,1) move to (0,2) would like this: 0102" << endl;
		cin >> move;
		x1 = move[0] - 48;
		y1 = move[1] - 48;
		x2 = move[2] - 48;
