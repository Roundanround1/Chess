...
//This section referred to as Whole Display
    ...
    for(int i = 0; i < size; i++)
    {
        ...
        for(int j = 0; j < size; j++)
        {
            if (game[i][j].team == 'R')
            {
                cout << "\33[31m" << game[i][j].piece << "\33[0m" << ' ';
                //\33[31m
            }
            else if (game[i][j].team == 'W')
            {
                cout << "\33[0m" << game[i][j].piece << ' ';
                //\33[0m
            }
        }
        cout << endl;
    ...
    while(GameOver == false)
    {
        if (turn == true) //Prints for player one (White)
        {
            while (CanMove == false)
            {
                ...
                {
                    cout << "\e[0;33mThis is not your piece try again.\33[0m" << endl << endl;
                }
            }
            CanMove = false;
...
// ------------------------------------------------------------------------------------------------------------------------
                ...
                if (game[x1][y1].team == 'R' && x1 == 1)
                {
                    ...
                    {
                        cout << "\e[0;33mInvalid move please try again.\33[0m" << endl << endl;
                        Valid = true;
                    }
                }
